"""
GovCon app entry point.
Patrick auto-discovers this module and registers it as a route.
Exposes: DESCRIPTION (str) and graph (compiled StateGraph).
"""
from apps.govcon.db import init_db
from apps.govcon.graphs.discovery import graph
